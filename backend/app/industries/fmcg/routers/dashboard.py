...
async def auto_analyze(current_user=Depends(get_current_user)):
    ...
    """
    uid = str(current_user.id)
    from app.industries.fmcg.services.forecast_service import (
    ...
    from app.industries.fmcg.routers.forecasting import _persist_demand_history
    from app.industries.fmcg.routers.inventory import _persist_inventory_items, STATUS_MAP
