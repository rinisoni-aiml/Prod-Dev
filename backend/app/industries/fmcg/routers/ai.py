...
from app.industries.fmcg.models.chat import ChatMessage, ChatResponse, ChatSession
from app.dependencies import get_current_user
from app.industries.fmcg.services.ai_service import generate_ai_response, generate_insights
