...
from app.shared.models.auth import LoginRequest, SignupRequest, TokenResponse, ProfileUpdate
from app.shared.services.auth_service import authenticate_user, create_user
